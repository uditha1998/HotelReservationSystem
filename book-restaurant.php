...
<br>
                                                <div class="form-group shadow-textarea">
                                                    <label for="exampleFormControlTextarea6">Meal Description</label>
                                                    <textarea class="form-control z-depth-1" id="mealDescription" rows="3" placeholder="Enter meal type breakfirst lunch or dinner and what are the meals you want"></textarea>
                                                    </div>
                                            ...
                                            <input type="hidden" id="cusId" value="<?php echo $id?>">
                                             <br>
                                                ...
                                                <span style="margin-left:240px"><a class="btn btn-info" id="restaurantCalculateBtn"
        ...
        <div class="modal fade" id="modalContactForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button class="btn btn-success" id="restaurantBooking">Confirm Booking</button>
                </div>
                </div>
            </div>
</div>
