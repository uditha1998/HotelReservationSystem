...
<html>
    ...
    <body>
                                    ...
                                    <form enctype="multipart/form-data" id="form-data" method="post">
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <input type="text" class="form-control" value="<?= $gallery['name'] ?>" id="title" name="title" >
                                            </div>

                                            <div class="mb-3 col-md-12">
                                                <label for="inputPassword4">Image</label>
                                                <input type="file" class="form-control"  value="<?= $gallery['image'] ?>" id="image" name="image">
                                                <img class="mt-3" src="./../upload/gallery/<?= $gallery['image'] ?>" width="200">
                                            </div>
                                            <div class="mb-3 col-md-12">
                                        ...
                                        <input type="hidden" id="oldImageName" value="<?= $gallery['image'] ?>" name="oldImageName"/>
        ...
        <script src="validations/js/gallery.js" type="text/javascript"></script>
        <script>
