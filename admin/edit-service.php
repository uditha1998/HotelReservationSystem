                                    ...
                                    <form enctype="multipart/form-data" id="form-data" method="post">
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <input type="text" class="form-control" value="<?= $service['title'] ?>" id="title" name="title" >
                                            </div>

                                            <div class="mb-3 col-md-12">
                                                <label for="inputPassword4">Image</label>
                                                <input type="file" class="form-control"  value="<?= $service['image'] ?>" id="image" name="image">
                                                <img class="mt-3" src="./../upload/service/<?= $service['image'] ?>" width="200">
                                            </div>
                                        ...
                                        <input type="hidden" id="oldImageName" value="<?= $service['image'] ?>" name="oldImageName"/>
