                ...
                <main class="content">
                    <div class="container-fluid">
                        ...
                        <div class="col-xl-12 d-flex" style="flex-wrap: wrap">
                            ...
                            foreach ($Attraction->getterAllByAttraction() as $Attraction){
                            ?>
                            <div class="col-md-3" id="div<?=$Attraction['id']?>">
                                <div class="card" style="margin-right: 10px">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col mt-0 text-center">
                                                <h2 class="card-title" style="font-size: 1.1rem;"><?=$Attraction['name']?></h2>
                                            </div>

                                        </div>
                                        <div class="col">
                                            <img class="img-responsive img-rounded mt-2 mb-4" src="./../upload/attraction/<?=$Attraction['image'];?>"  style="width: 100%" width="400">

                                        </div>
                                        <div class="row" >

                                            <div class="col-4">
                                                <a href="./edit-attraction.php?id=<?=$Attraction['id'];?>">
                                                    <div class="avatar">
                                            ...
                                            <div class="col-4" >
                                            <a  class="delete-attraction" data-id="<?=$Attraction['id'];?>">
                                                    <div class="avatar">
                                                        <div class="avatar-title rounded-circle bg-primary-dark">
