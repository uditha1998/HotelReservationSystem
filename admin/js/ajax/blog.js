                ...
                success: function (result) {
                    ...
                    swal({
                            ...
                            setTimeout(function () {
                                ...
                                window.location.reload("manage-blog.php");
                ...
                success: function (result) {
                    ...
                    swal({
                        ...
                        setTimeout(function () {
                            ...
                            window.location.replace("edit-blog.php?id=" + result.id);
                ...
                success: function (result) {
                    ...
                    swal({
                        ...
                        setTimeout(function () {
                            ...
                            window.location.reload("manage-blog-photos.php?id=" + result.id);
                ...
                success: function (result) {
                    ...
                    swal({
                        ...
                        setTimeout(function () {
                            ...
                            window.location.replace("edit-blog-photos.php?id=" + result.id);
