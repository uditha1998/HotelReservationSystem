$(document).ready(function () {
    ...
    $("#create").click(function (event) {
        ...
        if (!$('#short').val() || $('#short').val().length === 0) {
                    ...
                    if (result.status === 'success') {
                        swal({
                            ...
                            setTimeout(function () {
                                ...
                                window.location.reload("manage-about.php");
                ...
                success: function (result) {
                    ...
                    swal({
                        ...
                        setTimeout(function () {
                            ...
                            window.location.replace("edit-about.php?id=" + result.id);
