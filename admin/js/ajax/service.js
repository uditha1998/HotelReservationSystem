$(document).ready(function () {
    ...
    $("#create").click(function (event) {
        ...
        } else if (!$('#icon').val() || $('#icon').val().length === 0) {
                ...
                success: function (result) {
                    ...
                    swal({
                        ...
                        setTimeout(function () {
                            ...
                            window.location.reload("manage-service-photos.php?id=" + result.id);
                ...
                success: function (result) {
                    ...
                    swal({
                        ...
                        setTimeout(function () {
                            ...
                            window.location.reload("edit-service-photos.php?id=" + result.id);
