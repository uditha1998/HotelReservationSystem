...
<br>
                                                <div class="form-group shadow-textarea">
                                                    <label for="exampleFormControlTextarea6">Event Description</label>
                                                    <textarea class="form-control z-depth-1" id="eventDescription" rows="3" placeholder="Enter event type Birthday Engagement Wedding etc.."></textarea>
                                                    </div>
                                            ...
                                            <input type="hidden" id="serviceType" value="Event">
                                            <input type="hidden" id="cusId" value="<?php echo $id?>">
                                             <br>

                                            
                                                <span style="margin-left:240px"><a class="btn btn-info" id="eventCalculateBtn"
        ...
        <div class="modal fade" id="modalContactForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button class="btn btn-success" id="eventBooking">Confirm Booking</button>
                </div>
                </div>
            </div>
</div>
