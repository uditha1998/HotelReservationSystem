...
<!--[if (gt IE 9)|!(IE)]><!--> <body> <!--<![endif]-->
    ...
    <div id="page-wrap">
                                                        ...
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="card-body">
                                                                    ...
                                                                    <a  class="ViewBooking" booking-id="<?=$bookings['id'];?>"
                                                                    data-target="#modalViewReview" data-toggle="modal" href="#">View</a>
                                                                </p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                ...
                                                                <br>
                                                                <div style="background-color: #d9deb4; border-radius: 25px; width: 150px;height: 130px;margin-left: -45px;">
        ...
        <!-- view booking model -->
        <div class="modal fade" id="modalViewReview" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header text-center">
